(window.SCREENS = window.SCREENS || {})['screens/grades.html'] = `
<div class="screen" style="overflow:hidden;background:var(--bg-secondary)">
  ...
  <div style="flex-shrink:0;background:var(--bg-primary);display:flex;align-items:center;gap:4px;padding:8px 6px 8px 16px;min-height:60px">
    <div style="flex:1;min-width:0">
      <div style="font-size:28px;font-weight:600;line-height:36px;color:var(--text-primary)">Оценки</div>
    </div>
    <button onclick="Router.goTo('/notifications')" style="position:relative;width:44px;height:44px;border:none;background:transparent;cursor:pointer;border-radius:var(--radius-s);display:flex;align-items:center;justify-content:center;flex-shrink:0;touch-action:manipulation">
      <span class="grades-notif-dot" style="display:none;position:absolute;top:8px;right:8px;width:8px;height:8px;border-radius:50%;background:#e93334;border:1.5px solid var(--bg-primary)"></span>
  ...
  <div class="home-scroll">
    <div style="padding:16px 16px 24px;display:flex;flex-direction:column;gap:24px">

      <div class="grades-main">
        <div class="moti-widget">
          <div class="moti-top">
            <div class="moti-name">Моти</div>
            <div class="moti-level-tag"></div>
          </div>
          <div class="moti-body">
            <div class="moti-left">
              <div class="moti-message">
                <div class="moti-msg-title"></div>
                <div class="moti-msg-subtitle"></div>
              </div>
              <div class="moti-progress">
                <div class="moti-progress-track"><div class="moti-progress-fill"></div></div>
                <div class="moti-progress-text"></div>
              </div>
            </div>
            <div class="moti-image-frame">
              <img class="moti-image" src="images/mascot/grades-widget.png" alt="Моти">
            </div>
          </div>
          <a class="moti-link" href="#" target="_blank" rel="noopener noreferrer">Перейти</a>
        </div>

        <div class="grades-selector-card">
          <button type="button" class="grades-class-select" data-value="8 класс">
            <span class="grades-class-input"></span>
            <img src="icons/arrow-right.svg" class="grades-class-arrow" alt="">
          </button>
          <div class="grades-quarter-section">
            <div class="t-bodys c-secondary">Четверть</div>
            <div class="grades-quarter-tabs">
              <button class="quarter-tab" data-q="1">1-я</button>
              <button class="quarter-tab" data-q="2">2-я</button>
              <button class="quarter-tab active" data-q="3">3-я</button>
              <button class="quarter-tab" data-q="4" disabled>4-я</button>
            </div>
          </div>
        </div>
      </div>
